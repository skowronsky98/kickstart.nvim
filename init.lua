...
-- TIP: Disable arrow keys in normal modeiknk
-- vim.keymap.set('n', '<left>', '<cmd>echok k"Use h to move!!"<CR>')
...
require('lazy').setup({
  ...
  'tpope/vim-sleuth', -- Detect tabstop and shiftwidth automaticallyini
...

  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>pr', function()
        harpoon:list():remove()
      end, { desc = '[R]emove file from list' })

      vim.keymap.set('n', '<leader>pn', function()
        harpoon:list():next()
      end, { desc = '[N]ext file from list' })

      vim.keymap.set('n', '<leader>pp', function()
        harpoon:list():prev()
      end, { desc = '[P]revious file from list' })
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>bh', builtin.git_bcommits, { desc = '[B]uffer [C]ommits' })
  ...
  { -- LSP Configuration & Plugins
    ...
    config = function()
      ...
      -- LSP servers (only actual language servers, not formatters/linters)
      local servers = {
        clangd = {},
        gopls = {
          cmd = { 'gopls' },
      ...
      -- formatters and linters installed via mason but NOT LSP servers
      local extra_tools = { 'stylua', 'prettierd', 'tflint', 'goimports' }
